// load_current_patch.cpp
#include "load_dialog/load_dialog.h"
#include "ui_Load_Dialog.h"
#include "JVlibForm.h"

void Load_Dialog::load_current_patch(int SerNum, int pn) {
  // pull patch and tone data by SerNumber from db into QByteArray, load into Active area on JV
