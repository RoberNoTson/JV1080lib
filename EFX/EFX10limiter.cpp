...
void JVlibForm::EFX10limiter() {
  ...
  if (SysMode_select->currentIndex()==0 && MainTabWidget->currentIndex()==1) {	// get Performance EFX settings
    EFXparm1_label->setText(QString("Threshold"));
    ...
    EFXparm2_label->setText(QString("Release Time"));
    ...
    EFXparm5_label->setText(QString("Post Gain"));
    PerfEFXparm5_select->setRange(0, 3);
  ...
  if (MainTabWidget->currentIndex()>1) {		// PatchEFX tab settings for either Perf or Patch
    ...
    PatchEFX_parm1_label->setText(QString("Threshold"));
    ...
    PatchEFX_parm2_label->setText(QString("Release Time"));
    ...
    PatchEFX_parm3_label->setText(QString("Ratio"));
    ...
    PatchEFX_parm4_label->setText(QString("Pan"));
    ...
    PatchEFX_parm5_label->setText(QString("Post Gain"));
    PatchEFX_parm5_select->setRange(0, 3);
