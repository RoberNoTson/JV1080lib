...
void JVlibForm::EFX04phaser() {
  ...
  if (SysMode_select->currentIndex()==0 && MainTabWidget->currentIndex()==1) {	// get Performance EFX settings
    EFXparm1_label->setText(QString("Frequency Band"));
    ...
    EFXparm2_label->setText(QString("Rate"));
    ...
    EFXparm3_label->setText(QString("Depth"));
    ...
    EFXparm4_label->setText(QString("Resonance"));
    ...
    EFXparm5_label->setText(QString("Mix Level"));
    ...
    EFXparm6_label->setText(QString("Output Pan"));
  ...
  if (MainTabWidget->currentIndex()>1) {		// PatchEFX tab settings for either Perf or Patch
    ...
    PatchEFX_parm1_label->setText(QString("Frequency Band"));
    ...
    PatchEFX_parm2_label->setText(QString("Rate"));
    ...
    PatchEFX_parm3_label->setText(QString("Depth"));
    ...
    PatchEFX_parm4_label->setText(QString("Resonance"));
    ...
    PatchEFX_parm5_label->setText(QString("Mix Level"));
    ...
    PatchEFX_parm6_label->setText(QString("Output Pan"));
