// EFX19TripleTapDelay.cpp

#include	"JVlibForm.h"
#include	<QtGui>
#include	"EFX/EFX.h"

void JVlibForm::EFX19TripleTapDelay() {
      enable_4(true);
      enable_6(true);
      enable_7(true);
      enable_8(true);
  ...
  if (SysMode_select->currentIndex()==0 && MainTabWidget->currentIndex()==1) {	// get Performance EFX settings
      ...
      EFXparm2_label->setText(QString("Right Delay Time ms"));
      ...
      EFXparm3_label->setText(QString("Center Delay Time ms"));
      ...
      EFXparm6_label->setText(QString("Left Level"));
      ...
      EFXparm7_label->setText(QString("Right Level"));
      ...
      EFXparm8_label->setText(QString("Center Level"));
  ...
  if (MainTabWidget->currentIndex()>1) {		// PatchEFX tab settings for either Perf or Patch
    ...
    PatchEFX_parm1_label->setText(QString("Left Delay Time ms"));
    ...
    PatchEFX_parm2_label->setText(QString("Right Delay Time ms"));
    ...
    PatchEFX_parm3_label->setText(QString("Center Delay Time ms"));
    ...
    PatchEFX_parm6_label->setText(QString("Left Level"));
    ...
    PatchEFX_parm7_label->setText(QString("Right Level"));
    ...
    PatchEFX_parm8_label->setText(QString("Center Level"));
