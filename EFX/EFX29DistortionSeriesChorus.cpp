// EFX29DistortionSeriesChorus.cpp

#include	"JVlibForm.h"
#include	<QtGui>
#include	"EFX/EFX.h"

void JVlibForm::EFX29DistortionSeriesChorus() {
      enable_4(true);
      enable_6(false);
      enable_7(true);
      enable_8(true);
  ...
  if (state_table->perf_mode && MainTabWidget->currentIndex()==1) {	// get Performance EFX settings
      ...
      EFXparm3_label->setText(QString("Chorus PreDelay"));
      ...
      EFXparm7_label->setText(QString("Chorus Balance"));
  ...
  if (MainTabWidget->currentIndex()>1) {		// PatchEFX tab settings for either Perf or Patch
    ...
    PatchEFX_parm2_select->setValue(val>0 ?
      ...
      PatchEFX_parm3_label->setText(QString("Chorus PreDelay"));
    ...
    PatchEFX_parm5_select->setValue(val>0 ?
      ...
      PatchEFX_parm7_label->setText(QString("Chorus Balance"));
...
}	// end EFX29DistortionSeriesChorus
