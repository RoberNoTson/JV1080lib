// EFX39FlangerParallelDelay.cpp

#include	"JVlibForm.h"
#include	<QtGui>
#include	"EFX/EFX.h"

void JVlibForm::EFX39FlangerParallelDelay() {
      enable_4(true);
      enable_6(true);
      enable_7(true);
      enable_8(true);
  ...
  if (state_table->perf_mode && MainTabWidget->currentIndex()==1) {	// get Performance EFX settings
      EFXparm1_label->setText(QString("Flanger PreDelay"));
      ...
      EFXparm2_label->setText(QString("Flanger Rate"));
      ...
      EFXparm3_label->setText(QString("Flanger Depth"));
  ...
  if (MainTabWidget->currentIndex()>1) {		// PatchEFX tab settings for either Perf or Patch
	...
	pn = val-1;
    PatchEFX_parm1_label->setText(QString("Flanger PreDelay"));
    ...
    PatchEFX_parm2_label->setText(QString("Flanger Rate"));
    ...
    PatchEFX_parm3_label->setText(QString("Flanger Depth"));
    ...
    PatchEFX_parm4_label->setText(QString("Flanger Feedback"));
    ...
    PatchEFX_parm5_label->setText(QString("Flanger Balance"));
