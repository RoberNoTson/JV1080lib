// EFX21TimeControlDelay.cpp

#include	"JVlibForm.h"
#include	<QtGui>
#include	"EFX/EFX.h"

void JVlibForm::EFX21TimeControlDelay() {
      enable_4(true);
      enable_6(true);
      enable_7(true);
      enable_8(true);
  ...
  if (SysMode_select->currentIndex()==0 && MainTabWidget->currentIndex()==1) {	// get Performance EFX settings
      ...
      EFXparm9_label->setText(QString("Output Level"));
  ...
  if (MainTabWidget->currentIndex()>1) {		// PatchEFX tab settings for either Perf or Patch
    ...
    int pn = (val>0 ? val-1 : 0);
      PatchEFX_parm1_label->setText(QString("Delay Time"));
      PatchEFX_parm1_select->setRange(0, 120);
    PatchEFX_parm1_select->setValue(val>0 ?
      ...
      PatchEFX_parm2_label->setText(QString("Feedback"));
      PatchEFX_parm2_select->setRange(0, 98);
    PatchEFX_parm2_select->setValue(val>0 ?
      ...
      PatchEFX_parm3_label->setText(QString("Acceleration"));
      PatchEFX_parm3_select->setRange(0, 15);
    PatchEFX_parm3_select->setValue(val>0 ?
      ...
      PatchEFX_parm4_label->setText(QString("HF Damp"));
    ...
    PatchEFX_parm4_select->setValue(val>0 ?
      ...
      PatchEFX_parm5_label->setText(QString("Balance"));
    ...
    PatchEFX_parm5_select->setValue(val>0 ?
      ...
      PatchEFX_parm6_label->setText(QString("Low Gain"));
    ...
    PatchEFX_parm6_select->setValue(val>0 ?
      ...
      PatchEFX_parm7_label->setText(QString("High Gain"));
    ...
    PatchEFX_parm7_select->setValue(val>0 ?
      ...
      PatchEFX_parm8_label->setText(QString("Output Pan"));
    ...
    PatchEFX_parm8_select->setValue(val>0 ?
      ...
      PatchEFX_parm9_label->setText(QString("Output Level"));
