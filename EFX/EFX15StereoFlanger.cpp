// EFX15StereoFlanger.cpp
#include        "JVlibForm.h"
#include        <QtGui>
#include        "EFX/EFX.h"

void JVlibForm::EFX15StereoFlanger() {
  enable_4(true);
  enable_6(true);
  enable_7(true);
  enable_8(true);
  ...
  if (state_table->perf_mode && MainTabWidget->currentIndex()==1) {	// get Performance EFX settings
    ...
    EFXparm4_label->setText(QString("LFO Rate"));
    ...
    EFXparm5_label->setText(QString("LFO Depth"));
    ...
    EFXparm7_label->setText(QString("Feedback"));
  ...
  if (MainTabWidget->currentIndex()>1) {		// PatchEFX tab settings for either Perf or Patch
    ...
    PatchEFX_parm4_label->setText(QString("LFO Rate"));
    ...
    PatchEFX_parm5_label->setText(QString("LFO Depth"));
    ...
    PatchEFX_parm7_label->setText(QString("Feedback"));
