...
void JVlibForm::EFX25GateReverb() {
      enable_4(true);
      enable_6(true);
      enable_7(true);
      enable_8(false);
  ...
  if (SysMode_select->currentIndex()==0 && MainTabWidget->currentIndex()==1) {	// get Performance EFX settings
      ...
      PerfEFXparm1_select->setRange(0,31);
      ...
      EFXparm3_label->setText(QString("Gate Time"));
      ...
      EFXparm6_label->setText(QString("Balance"));
  ...
  if (MainTabWidget->currentIndex()>1) {		// PatchEFX tab settings for either Perf or Patch
    ...
    int pn = (val>0 ? val-1 : 0);
      ...
      PatchEFX_parm1_select->setRange(0,31);
    ...
    PatchEFX_parm2_select->setValue(val>0 ?
      ...
      PatchEFX_parm3_label->setText(QString("Gate Time"));
    ...
    PatchEFX_parm5_select->setValue(val>0 ?
      ...
      PatchEFX_parm6_label->setText(QString("Balance"));
