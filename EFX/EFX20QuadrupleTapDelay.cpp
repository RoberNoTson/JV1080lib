// EFX20QuadrupleTapDelay.cpp

#include	"JVlibForm.h"
#include	<QtGui>
#include	"EFX/EFX.h"

void JVlibForm::EFX20QuadrupleTapDelay() {
      enable_4(true);
      enable_6(true);
      enable_7(true);
      enable_8(true);
  ...
  if (state_table->perf_mode && MainTabWidget->currentIndex()==1) {	// get Performance EFX settings
      EFXparm1_label->setText(QString("Delay Time 1 ms"));
      ...
      EFXparm2_label->setText(QString("Delay Time 2 ms"));
      PerfEFXparm2_select->setRange(0, 115);
      PerfEFXparm2_select->setValue(active_area->active_performance.perf_common.EFX_parameter[1]);
      EFXparm3_label->setText(QString("Delay Time 3 ms"));
      PerfEFXparm3_select->setRange(0, 115);
      PerfEFXparm3_select->setValue(active_area->active_performance.perf_common.EFX_parameter[2]);
      EFXparm4_label->setText(QString("Delay Time 4 ms"));
      PerfEFXparm4_select->setRange(0, 115);
      PerfEFXparm4_select->setValue(active_area->active_performance.perf_common.EFX_parameter[3]);
      EFXparm5_label->setText(QString("Level 1"));
      ...
      EFXparm6_label->setText(QString("Level 2"));
      ...
      EFXparm7_label->setText(QString("Level 3"));
      ...
      EFXparm8_label->setText(QString("Level 4"));
      ...
      EFXparm9_label->setText(QString("Feedback"));
      PerfEFXparm9_select->setRange(0, 98);
      PerfEFXparm9_select->setValue(active_area->active_performance.perf_common.EFX_parameter[8]);
      EFXparmA_label->setText(QString("High Freq Dampen"));
      PerfEFXparmA_select->setRange(0, 17);
  ...
  if (MainTabWidget->currentIndex()>1) {		// PatchEFX tab settings for either Perf or Patch
    ...
    int pn = (val>0 ? val-1 : 0);
      PatchEFX_parm1_label->setText(QString("Delay Time 1 ms"));
      PatchEFX_parm1_select->setRange(0, 115);
    PatchEFX_parm1_select->setValue(val>0 ?
      ...
      PatchEFX_parm2_label->setText(QString("Delay Time 2 ms"));
      PatchEFX_parm2_select->setRange(0, 115);
    PatchEFX_parm2_select->setValue(val>0 ?
      ...
      PatchEFX_parm3_label->setText(QString("Delay Time 3 ms"));
      PatchEFX_parm3_select->setRange(0, 115);
    PatchEFX_parm3_select->setValue(val>0 ?
      ...
      PatchEFX_parm4_label->setText(QString("Delay Time 4 ms"));
      PatchEFX_parm4_select->setRange(0, 115);
    PatchEFX_parm4_select->setValue(val>0 ?
      ...
      PatchEFX_parm5_label->setText(QString("Level 1"));
    ...
    PatchEFX_parm5_select->setValue(val>0 ?
      ...
      PatchEFX_parm6_label->setText(QString("Level 2"));
    ...
    PatchEFX_parm6_select->setValue(val>0 ?
      ...
      PatchEFX_parm7_label->setText(QString("Level 3"));
    ...
    PatchEFX_parm7_select->setValue(val>0 ?
      ...
      PatchEFX_parm8_label->setText(QString("Level 4"));
    ...
    PatchEFX_parm8_select->setValue(val>0 ?
      ...
      PatchEFX_parm9_label->setText(QString("Feedback"));
      PatchEFX_parm9_select->setRange(0, 98);
    PatchEFX_parm9_select->setValue(val>0 ?
      ...
      PatchEFX_parmA_label->setText(QString("High Freq Dampen"));
      PatchEFX_parmA_select->setRange(0, 17);
