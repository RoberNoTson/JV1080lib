...
void JVlibForm::setScaleTunings(int partnum) {
  ...
  else if (cur_chksum==53569) {Tuning_JustTemp_button->setChecked(true); state_table->tuning_type=JustTemp; Tuning_BaseKey_select->setEnabled(true);}
  else if (cur_chksum==15732) {Tuning_MeantoneTemp_button->setChecked(true); state_table->tuning_type=MeantoneTemp; Tuning_BaseKey_select->setEnabled(true);}
  else if (cur_chksum==52045) {Tuning_PureTemp_button->setChecked(true); state_table->tuning_type=PureTemp; Tuning_BaseKey_select->setEnabled(true);}
