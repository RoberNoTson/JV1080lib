...
void JVlibForm::setPart10_Parms() {
  ...
  Part10_Pan_select->setValue(active_area->active_performance.perf_part[9].pan-64);
...
//    Part10_PatchGroup_select->setEnabled(Part10_ReceivePrgChg_enable->isChecked() && AcceptBankSel_switch->isChecked());
  ...
  if (state_table->GM_mode) {
      ...
      Part10_ReceivePrgChg_enable->setEnabled(false);
      Part10_ReceiveVolume_enable->setEnabled(false);
      Part10_ReceiveHold_enable->setEnabled(false);
      Part10_ReceiveMidi_enable->setEnabled(false);
  }
