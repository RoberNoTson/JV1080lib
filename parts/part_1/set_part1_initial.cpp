...
void JVlibForm::setPart1_Parms() {
  ...
  switch(active_area->active_performance.perf_part[0].patch_group_id) {
    ...
    Part1_PatchGroup_select->setEnabled(Part1_ReceivePrgChg_enable->isChecked() && AcceptBankSel_switch->isChecked()); 
  ...
  Part1_SetPatchMax();
  Part1_PatchNumber_select->setEnabled(Part1_ReceivePrgChg_enable->isChecked() && AcceptProgramChg_switch->isChecked()); 
