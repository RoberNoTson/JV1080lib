...
void JVlibForm::setPart2_Parms() {
  ...
  Part2_Pan_select->setValue(active_area->active_performance.perf_part[1].pan-64);
//  Part2_Pan_select->setStatusTip(str.setNum(active_area->active_performance.perf_part[1].pan));
  ...
  Part2_VoiceReserve_select->setValue(active_area->active_performance.perf_common.voice_reserve[0]);
  ...
  if (state_table->GM_mode) {
      ...
      Part2_PatchNumber_select->setValue(1);
      Part2_PatchName_display->setText(getPartPatchName(0));
